...
<head>
    ...
    <meta name="title" content="About Us - Leading Recruitment Agency | Stakefield">
    <meta name="description" content="Being a leading recruitment staffing agency, Stakefield helps organizations find the right professionals for their business easily. Contact us to know more.">
    <meta name="keywords" content="stakefield">
    
    <link rel="icon" href="./img/logo/favicon/black.png" type="image/png" sizes="32x32">
    <title>About Us - Leading Recruitment Agency | Stakefield</title>
    <!-- Font Icons -->
...
<body class="white-overlay">
        ...
        <div class="page-wrapper">
            ...
            <main class="banner">
                ...
                <section class="visual">
                    <div class="colored-bg fullscreen-bg dark-overlay parallax" data-stellar-background-ratio="0.55" style="background-image: url('./img/big-15.jpg');">
                        <div class="centered centered-wrap text-center">
                            <div class="container">
                                <div class="visual-text visual-center">                              
                                    <h1 class="visual-title visual-sub-title">About US
                                    </h1>
                              <p>
                                Being a leading recruitment agency, we help organizations find the right talent easily.
                              </p>
    ...
    <div class="content-wrapper">
        <section class="content-block" style="padding-top: 0;">
            <div class="container">
                <div class="demo-wrapper content-block text-center" style="padding-bottom: 4em;">
                    <h3>Who we are?</h3>
                    <div class="divider-v2"></div>
                    <p>Recruitment is much more than just finding the right people. Unlocking efficiency levels in terms of
                        creativity and sharpness in the way those people are found and the way our clients do business is 
                        what makes Stakefield stand out in its absolute sense. Stakefield provides the company insights into
                        every aspect of its talent spending while concurrently increasing the quality of its talent pool. Every 
                        day, a specially deployed Stakefield Innovation Team is working for its client to find even more 
                        efficiencies to make the way the company does business better and smarter</p>
                </div>
                    ...
                    <div class="row multiple-row">
                        <div class="col-lg-4 col-md-6">
                            <div class="col-wrap ">
                                <div class="ico-box bg-gray-light" >
                                    <div class="icon">
                                        <span class="waituk-icon-layers"><span
                                                class="sr-only">&amp;</span></span>
                                    </div>
                                    <h4 class="content-title"><a href="#">Mission</a></h4>
                                    <div class="des">
                                        <p >Our goal is to help you succeed, reduce costs and make the most of your technology investment. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="col-wrap">
                                <div class="ico-box bg-gray-light" >
                                    <div class="icon">
                                        <span class="waituk-icon-list"><span
                                                class="sr-only">&amp;</span></span>
                                    </div>
                                    <h4 class="content-title"><a href="#">Vision</a></h4>
                                    <div class="des">
                                        <p >Our business is about delivering customer friendly solutions driven by value, service and
                                            integrity to meet client requirements, on time.</p>
                                    </div>             
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="col-wrap">
                                <div class="ico-box bg-gray-light">
                                    <div class="icon">
                                        <span class="custom-icon-vector"><span
                                                class="sr-only">&amp;</span></span>
                                    </div>
                                    <h4 class="content-title"><a href="#">Values</a></h4>
                                    <div class="des" tyle="text-align: justify;">
                                        <p>Our business is about delivering customer friendly solutions driven by value, service and
                                            integrity to meet client requirements, on time.</p>
                                    </div>
                                </div>
     ...
     <!-- Who we are wrapper ends-->


 <!-- What drives us wrapper -->
    <section>
 
    <div class="content-wrapper">
        <section class="content-block" style="padding-top: 0;">
            <div class="container">
                <div class="demo-wrapper content-block text-center" style="padding: 0 0 3em 0;">
                    <h3>What Drives Us Ahead?
                    </h3>
                    <div class="divider-v2"></div>
                </div>
                <div class="demo-wrapper">
                    <div class="row multiple-row">
                        <div class="col-lg-4 col-md-6">
                            <div class="col-wrap">
                                <div class="ico-box bg-gray-light">
                                    <div class="icon">
                                        <span class="waituk-icon-pen-tool"><span
                                                class="sr-only">&amp;</span></span>
                                    </div>
                                    <h4 class="content-title"><a href="#">Quality</a></h4>
                                    <div class="des">
                                        <p >Stakefields are committed to offering quality and reliable recruitment services to clients all over the 
                                            world. </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="col-wrap">
                                <div class="ico-box bg-gray-light">
                                    ...
                                    <h4 class="content-title"><a href="#">Respect</a></h4>
                                    <div class="des">
                                        <p >Our consultants' respects each other and work as a single team to help you achieve the desired 
                                            output</p>
                                    </div>             
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="col-wrap">
                                <div class="ico-box bg-gray-light">
                                    ...
                                    <div class="des" tyle="text-align: justify;">
                                        <p>We uphold the highest professional standard and ensure to build trust with our clients.
                                        </p>
                                    </div>
                                </div>
                            </div>
     ...
     <!-- What drives us ahead wrapper ends-->
