    ...
    <div id="wrapper">
        <div class="page-wrapper">
            ...
            <section class="banner mt-5"
                style="background-image: url('img/anees-ceo.jpg');background-position: center;background-size: cover;">
                <div class="container py-5">
                    <div class="row">
                        <div class="col-sm-8 col-md-8 pt-5">
                            <h3>CEO Message</h3>
                            <p>We consider our reputation and goodwill as one of the valuable assets of the company. We
                                as a team, work so hard to attain this position and achieve this honor that we enjoy as
                                of today. Its our honesty, courteous behavior, and fair dealing that pave the way to
                                build a prominent reputation and trust in hearts of our clients. Quality service and the
                                team of exuberant employees are the area wherein we give more empresses to.
                            </p>
                            <p>All members of Stakefield family are responsible and accountable towards their client
                                with no differentiation and are obliged to maintain a high standard of integrity.
                                Stakefield has its ethical and legal responsibilities with regards to all activities of
                                employees that further include the dealings towards the client and their satisfaction.
                                By providing proper quality services, we must not aim at customer satisfaction alone but
                                further make sure of our customers save their time and money and make their work much
                                easier and effortless. As we wish for the success of our customers, we always make sure
                                no mistakes or omissions arise from our end.
                            </p>
                            <p>Stakefield makes sure that the client achieves tangible, high-impact results.<br> Our
                                approach to every work is simple and has given the clients with answers they need to
                                make critical business decisions with greater certainty. We have put up with the values
                                of complete transparency, ethics, and quality services, complemented by dynamic
                                leadership & strong management. We offer you technique/strategy for your business with<br>
                                innovation that could lead to growth while driving bottom-line benefits giving it a
                                competitive edge.
                            </p>
                            <p>Looking ahead, we are focused on accelerating the execution of our growth strategies <br>
                                while continuing to build ourselves as a prominent brand. Let's make it certain that  <br>
                                through integrity and quality service we should make our customers smile
