        ...
        <div class="page-wrapper">
            ...
            <main class="banner">
                ...
                <section class="visual">
                    <div class="colored-bg  dark-overlay parallax" data-stellar-background-ratio="0.55" style="background-image: url('./img/case-study/03.jpg');">
                        <div class="centered centered-wrap text-center">
                            <div class="container">
                                <div class="visual-text visual-center ">    
                               
                                                      
                                    <h1 class="visual-title visual-sub-title">Contact Us
                                    </h1>
                ...
                <div class="demo-wrapper text-center">
                    ...
                    <div class="row multiple-row">
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 my-auto" >
                                    <img src="./img/flag/uk.svg" alt="" class="flag">
                                    <h4 class="content-title">SURREY</h4>
                                    <div class="des">
                                        <p>Suit 6 Westward,
                                            Glebeland Rd, Camberly,
                                            Surrey GU15 3DB
                                            United Kingdom
                                            <br>
                                            <span>Tel : +44 (203) 808 8373</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/uk.svg" alt="" class="flag">
                                    <h4 class="content-title">London</h4>
                                    <div class="des">
                                        <p>2 Ivyday Grove
                                            London,
                                            SW16 2XD,
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/usa.svg" alt="" class="flag">
                                    
                                    <h4 class="content-title">Delaware</h4>
                                    <div class="des">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/usa.svg" alt="" class="flag">
                                    <h4 class="content-title">California</h4>
                                    <div class="des">
                                        <p>830 Stewart Dr.
                                            Sunnyvale,
                                            CA 94085,
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/australia.svg" alt="" class="flag">
                                    <h4 class="content-title">Sydney</h4>
                                    <div class="des">
                                        <p>15/32-34 Mons Rd,
                                            Westmead NSW 2145,
                                            Australia
                                            <br>
                                            <span>Tel : +61 (435) 449 228</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/india.svg" alt="" class="flag">
                                    <h4 class="content-title">Kochi</h4>
                                    <div class="des">
                                        <p>Ground Floor, Athulya,
                                            Infopark Campus,
                                            Kochi 682042
                                            Kerala
                                            India
                                            <br>
                                            <span>Tel : +91 (484) 404 1616</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/uae.svg" alt="" class="flag">
                                    <h4 class="content-title">Dubai</h4>
                                    <div class="des">
                                        <p>Level 41, Emirates Towers
                                            Sheikh Zayed Road
                                            Dubai
                                            UAE
                                            <br>
                                            <span>Tel : 800 0311 0030</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/uae.svg" alt="" class="flag">
                                    <h4 class="content-title">Doha</h4>
                                    <div class="des">
                                        <p>Almana Tower,
                                            Airport Rd,
                                            P.O.Box 491,
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/belgium.svg" alt="" class="flag">
                                    <h4 class="content-title">Brunei</h4>
                                    <div class="des">
                                        <p>Unit A6 BH 1323
                                            2 F, Zainudeen Complex
                                            KG Anggerek Desa,
                                            Bandar Seri Begawan Brunei Darussalam
                                            <br>
                                            <span>Tel : +673 7182313</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 mx-auto">
                            <div class="equal_col  col-wrap">
                                <div class="equal_col ico-box has-shadow1 center_col" >
                                    <img src="./img/flag/malaysia.svg" alt="" class="flag">
                                    <h4 class="content-title">Malaysia</h4>
                                    <div class="des">
                                        <p>99 M Jalan SS 21/1A
                                            Damansara Utama
                                            47400 Petaling Jaya
                                            Selangor Malaysia
                                            <br>
                                            <span>Tel : +603 77310807</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
