                ...
                <div id="nav-section">
                    <div class="bottom-header container-fluid mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple" id="navbar-inner-container">
                            <form action="mega-menu-5.php" id="top-search" class="no-margin top-search">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown right-dropdown" data-animation="fadeIn">
                                        ...
                                        <ul class="dropdown-menu no-border-radius">
                                            ...
                                            <!-- <li><a href="blog-right-sidebar.php"> Capabilities </a></li> -->
                                            ...
                                            <li><a href="/sustainability-strategy"> Sustainability Strategy</a></li>
                                                ...
                                                <li><a href="/life-at-stakefield"> Life at StakeField
                                                </a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="/staffing-services"> Our Services </a>
                                    </li>
                                    <li class="dropdown right-dropdown" data-animation="fadeIn">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="index.php" data-title="Home"> Case Studies </a>
                                        <ul class="dropdown-menu no-border-radius">
