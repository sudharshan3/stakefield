...
<head>
    ...
    <link media="all" rel="stylesheet" href="./css/fonts/icomoon/icomoon.min.css">
    <link media="all" rel="stylesheet" href="./css/fonts/icomoon/xyz-icomoon.css">
                    ...
                    <div class="bottom-header container-fluid mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple"
                            ...
                            <a class="navbar-brand mr-auto m-sm-auto" href="index.html"> <img src="icons/LOGO.png"
                                    alt="roxine" style="width: 86px;object-fit: contain;filter: invert(1);"> <img
                                    src="icons/LOGO.png" alt="roxine" style="width: 86px;object-fit: contain;"> </a>
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown right-dropdown" data-animation="fadeIn">
                                        ...
                                        <ul class="dropdown-menu no-border-radius">
                                            ...
                                            <li><a href="socialresponsibility.html"> Corporate Social Responsibility
                                                </a></li>
            ...
            <main>
                        ...
                        <div id="rev_slider_70_1" class="rev_slider fullscreenabanner" style="display:none;"
                            ...
                            <ul>
                                <li class="slider-color-schema-dark" data-index="rs-2" data-transition="fade"
                                    ...
                                    <img src="img/visual-small-01.jpg" alt="image description" data-bgposition="center center"
                                    ...
                                    <div class="tp-caption tp-shape tp-shapewrapper" id="slide-1699-layer-10"
                                        ...
                                        data-paddingleft="[0,0,0,0]" style="background-color:rgba(0, 0, 0, 0.57);">
                                    </div>
                                    <div class="slider-sub-title text-white tp-caption tp-resizeme rs-parallaxlevel-0"
                                        ...
                                        data-responsive_offset="on" data-paddingright="[25,25,25,25]"
                                    ...
                                    <div class="slider-main-title text-white tp-caption tp-resizeme rs-parallaxlevel-1"
                                        ...
                                        data-letterspacing="['25','10','5','0']"
                                        data-lineheight="['184','100','72','60']" data-height="none"
                                    ...
                                    <div class="slider-text text-white tp-caption tp-resizeme rs-parallaxlevel-2"
                                        ...
                                        data-voffset="['450','230','110','110']" data-width="['600','555','555','480']"
                                        data-textalign="left" data-fontsize="['16','14','14','14']"
                                        data-lineheight="['30','30','22','22']" data-fontweight="400" data-height="none"
                                        data-whitespace="normal" data-transform_idle="o:1;"
                                        data-transform_in="z:0;rX:0deg;rY:0;rZ:0;sX:1.5;sY:1.5;skX:0;skY:0;opacity:0;s:1500;e:Power3.easeInOut;"
                                        data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                        data-mask_in="x:0px;y:0px;" data-mask_out="x:inherit;y:inherit;"
                                        ...
                                        Our Consultants are equipped with the requisite
                                        expertise and tools to help you find 'The Right Talent'
                                        for your organization. We can cover your custom
                                        needs with a solid solution mechanism, irrespective
                                        of the scale at which you'd like us to operate.
                ...
                <div class="content-wrapper">
                    <section class="content-block">
                        <div class="container">
                            <div class="row multiple-row " style="justify-content: center;">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="col-wrap">
                                        <div class="block-heading">
                                            ...
                                            <span class="block-sub-heading">Helping you find the right talents.</span>
                                            <div class="divider"><img src="img/divider.png" alt="images description">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="col-wrap equalcol">
                                        <div class="ico-box bg-gray-light has-radius-medium equalcol">
                                            ...
                                            <h5 class="content-title"><a href="ourservice.html">PERMANENT STAFFING &
                                                    PLACEMENT</a></h5>
                                            <div class="des">
                                                <p>We help you find the right talent for your organization in the
                                                    easiest and cost-effective way.</p>
                                            </div>
                                    ...
                                    <div class="col-wrap equalcol">
                                        <div class="ico-box bg-gray-light has-radius-medium equalcol">
                                            ...
                                            <h5 class="content-title"><a href="ourservice.html">CONTRACT-BASED
                                                    STAFFING</a></h5>
                                            <div class="des">
                                                <p>We ensure that the right people are deployed in the right positions
                                                    at short notice.</p>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="col-wrap equalcol">
                                        <div class="ico-box bg-gray-light has-radius-medium equalcol">
                                            ...
                                            <div class="des">
                                                <p>Our specialized consultant helps you in identifying the employees who
                                                    have the right skills and personalities.
                                                </p>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="col-wrap equalcol">
                                        <div class="ico-box bg-gray-light has-radius-medium equalcol">
                                            ...
                                            <div class="des">
                                                <p>With our managed service program you will get complete visibility
                                                    over your non-permanent workforce.</p>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6 ">
                                    <div class="col-wrap equalcol">
                                        <div class="ico-box bg-gray-light has-radius-medium equalcol">
                                            <div class="icon cardicon">
                                                <img src="icons/Background and identity verification services-01.png"
                                                    alt="">
                                            </div>
                                            <h5 class="content-title"><a href="ourservice.html">BACKGROUND & IDENTITY
                                                    VERIFICATION SERVICE</a></h5>
                                            <div class="des">
                                                <p>We check for legal as well as government ID verification to ensure
                                                    the candidates fit well within the client's organization.</p>
                                            </div>
                                ...
                                <!-- 
                                <div class="col-lg-4 col-md-6" style="display: flex;justify-content: center;align-items:center;">
                                    <div class="col-wrap text-center" >

                                        <a href="#"
                                            class="btn btn-small-font btn-primary has-radius-huge btn-arrow" >READ
                                            MORE<span class="c-ripple js-ripple"><span
                    ...
                    <section class="content-block quotation-block black-overlay-6 parallax"
                        data-stellar-background-ratio="0.55">
                        <div class="container">
                            <div class="inner-wrapper">
                                <h3 class="block-top-heading text-white">SOURCING THE BEST TALENTS FOR YOU</h3>
                                <h2 class="text-white">Helping you find the right professionals for your organization!
                                </h2>
                    ...
                    <section class="content-block pb-0">
                        <div class="container">
                            <div class="block-heading bottom-space">
                                ...
                                <h2 class="block-main-heading">CASE STUDY</h2>
                                <span class="block-sub-heading">We really love what we do & our work on every project
                                    truly reflects that.</span>
                                <div class="divider"><img src="img/divider.png" alt="images description"></div>
                            </div>
                            <div class="team-container">
                                <div class="owl-carousel group-slide bottom-m-space">
                                    <div class="slide-item .show_more">
                                        <div class="col-wrap">
                                            <div class="post-grid reverse-grid">
                                                <div class="img-block post-img">
                                                    <a href="#"><img src="img/case-study/01.jpg" alt="images"></a>
                                                ...
                                                <div class="post-text-block bg-gray-light">
                                                    ...
                                                    <p class="show_more">No one enterprise can be everything to
                                                        everyone, irrespective of its size or expertise at its disposal.
                                                        It may certainly appear an easy task to hire individuals who
                                                        would want to be employed at an
                                                        esteemed...</p>
                                    ...
                                    <div class="slide-item .show_more">
                                        <div class="col-wrap">
                                            <div class="post-grid reverse-grid">
                                                <div class="img-block post-img">
                                                    <a href="#"><img src="img/case-study/02.jpg" alt="images"></a>
                                                    <!-- <time class="post-date" datetime="2016-10-10">17 Jun</time> -->
                                                </div>
                                                <div class="post-text-block bg-gray-light">
                                                    <h4><a href="casestudy2.html">Contract-Based Employment</a></h4>

                                                    <p class="show_more">The client, a multi-billion dollar telecom
                                                        provider headquartered in Germany, was in search of a
                                                        partner who could support their efforts to overhaul their IT
                                                        systems of their data center through
                                                        ..... </p>
                                                    <div class="post-meta clearfix">
                                                        <div class="post-link-holder">
                                    ...
                                    <div class="slide-item .show_more">
                                        <div class="col-wrap">
                                            <div class="post-grid reverse-grid">
                                                <div class="img-block post-img">
                                                    <a href="#"><img src="img/case-study/03.jpg" alt="images"></a>
                                                    <!-- <time class="post-date" datetime="2016-10-10">17 Jun</time> -->
                                                </div>
                                                <div class="post-text-block bg-gray-light">
                                                    ...
                                                    <p class="show_more">One of the most innovative and funded startups
                                                        in Silicon Valley struggled to find suitable
                                                        candidates for their team. The startup worked with both local
                                                        and offshore recruiting partners that
                                                        were unable to come up with ....</p>
                                                    <div class="post-meta clearfix">
                                                        <div class="post-link-holder">
                                    ...
                                    <div class="slide-item ">
                                        <div class="col-wrap ">
                                            <div class="post-grid reverse-grid">
                                                <div class="img-block post-img">
                                                    <a href="#"><img src="img/case-study/04.jpg" alt="images"></a>
                                                    <!-- <time class="post-date" datetime="2016-10-10">17 Jun</time> -->
                                                </div>
                                                <div class="post-text-block bg-gray-light">
                                                    <h4><a href="casestudy4.html">Mass Hiring and Training</a></h4>

                                                    <p class="show_more">It is widely acknowledged that a company of
                                                        Stakefield’s reputation and presence, needs to go
                                                        through a number of permutations and combinations while staging
                                                        a mass recruitment process for
                                                        ... </p>
                                                    <div class="post-meta clearfix">
                                                        <div class="post-link-holder">
                    ...
                    <section class="content-block pt-0">
                        <div class="container">
                            <div class="block-heading bottom-space">
                                <h3 class="block-top-heading">OUR SECTOR OF</h3>
                                <h2 class="block-main-heading">EXPERTISE</h2>
                                <span class="block-sub-heading">Our global network and industry expertise allows us to
                                    recruit talents into various industries.</span>
                                <div class="divider"><img src="img/divider.png" alt="images description"></div>
                            </div>
                            <div class="team-container">
                                <div class="owl-carousel group-slide bottom-m-space">
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/ecommerce.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">ECOMMERCE</strong>
                                    ...
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/education.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">EDUCATIONAL</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/Engineering.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">ENGINEERING</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/Financials.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">FINANCE BANKS</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/health.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">HEALTHCARE</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/IT SERVICES.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">IT-SERVICE</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/manufacturing.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">MANUFACTURING</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/marketing.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">MARKETING</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/non-profit.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">NOT FOR PROFIT</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/public sector.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">PUBLIC SECTOR</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/startup.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">STARTUPS</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/support.jpg"alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">SUPPORT SERVICE</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/technology.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">TECHNOLOGY</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="slide-item">
                                        <figure class="team-box caption-fade-up">
                                            <div class="img-block rev-gray-scale">
                                                <img src="img/sector-expertise/telecom.jpg" alt="images description">
                                            </div>
                                            <figcaption class="text-right">
                                                <strong class="content-title mb-0">TELECOM</strong>
                                                <!-- <span class="sub">UI/UX GURU</span> -->
                                            </figcaption>
                                        </figure>
                                    </div>
                                </div>
                                <p> Stakefield provides sector agnostic solutions custom-tailored based on each client’s
                                    requirements.
                                    We specialize in both IT and non-IT recruitment in multiple sectors and have worked
                                    with a
                                    clientele across the globe. </p>
                            </div>
                        </div>
                    </section>
                    <h3 class="block-top-heading text-center">TECHNOLOGIES USED</h3>
                    <aside class="content-block pt-0">
                        <div class="container">
                            <div class="logo-container">
                                <div class="owl-carousel logo-slide" id="waituk-owl-slide-4">
                                    <div class="slide-item">
                                        <img src="technologies-used/1.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/2.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/3.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/4.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/5.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/6.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/7.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/8.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/9.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/10.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/11.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/12.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/13.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/14.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/15.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/16.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/17.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/18.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/19.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/20.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/21.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/22.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/23.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/24.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/25.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/26.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/27.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/28.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/29.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/30.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/31.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/32.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/33.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/34.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/35.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/36.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/37.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/38.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/39.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/40.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/41.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/42.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/43.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/44.png" alt="ADP">
                                    </div>

                                    <div class="slide-item">
                                        <img src="technologies-used/45.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/46.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/47.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/48.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/49.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/50.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/51.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/52.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/53.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/54.png" alt="ADP">
                                    </div>

                                    <div class="slide-item">
                                        <img src="technologies-used/55.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/56.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/57.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/58.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/59.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/60.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/61.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/62.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/63.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/64.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/65.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/66.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/67.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/68.png" alt="ADP">
                                    </div>
                                    <div class="slide-item">
                                        <img src="technologies-used/69.png" alt="ADP">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section style="margin-bottom: 4.5rem;">
                        <div class="container">
                            <div class="contact-container">
                                <h6 class="content-title contact-title" style="text-align: center;">GET STARTED WITH
                                    STAKEFIELD
                                </h6>
                                <div class="row">
                                    <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="YOUR NAME *" id="con_fname"
                                                            name="con_fname" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="EMAIL ADDRESS *" id="con_lname"
                                                            name="con_lname" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="tel" placeholder="COMPANY" id="con_phone"
                                                            name="con_phone" class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="email" placeholder="SUBJECT" id="con_email"
                                                            name="con_email" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <textarea class="form-control" placeholder="MESSAGE *" id="con_message"
                                                    name="con_message" required></textarea>
                                            </div>
                                            <div class="btn-container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="footer-logo">
                                <img style="filter:invert(1);width: 38%;" src="icons/LOGO.png" alt="image-description">
                            </div>
                        </div>
                        <div class="col-md-6">
